...
def get_scatter_chart(site,payload_range):
    ...
    df_fil=df[payload]
    if site == 'ALL':
        fig=px.scatter(df_fil, title= 'Correlation between Payload and Success for all Sites',
                    x='Payload Mass (kg)', y='class', 
                    color="Booster Version Category")
        return fig
    else:
        df_fil2=df_fil[df_fil["Launch Site"] == site]
        fig=px.scatter(df_fil2, title= 'Successful launches by Payload for ' + site,
                    x='Payload Mass (kg)', y='class', 
                    color="Booster Version Category")
        return fig
